...
include 'includes/header.php';
    ...
    $sql = "SELECT bids.*,MAX(bids.price) as price, products.*, customers.name, customers.id FROM bids JOIN products ON bids.product_id=products.id JOIN customers ON bids.customer_id=customers.id WHERE products.status = 2 GROUP BY bids.product_id ORDER BY bids.id";
    $row = $db->query($sql);
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="winDetails" class="table table-condensed">
                        <thead>
                            <tr>
                                <th>#</th>
                                <!--<th>Product image</th>-->
